...
//	error_log(date("Y-m-d H:i:s"). "\n" . $body, 3, "/var/www/html/errors.log");
    ...
    elseif(isset($_SERVER['HTTP_BECKON'])){
        ...
        elseif($_SERVER['HTTP_BECKON'] == "addBeckon"){
            $response = BeckonManager::addBeckon($user, $client->beckon->title, $client->beckon->description, $client->beckon->begins, $client->beckon->ends, array(), $client->beckon->location->latitude, $client->beckon->location->longitude, $client->beckon->friends);
        }
    }
